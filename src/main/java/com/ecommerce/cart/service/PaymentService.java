...
import com.ecommerce.cart.pattern.adapter.BankCardAdapter;
import com.ecommerce.cart.pattern.adapter.CreditCardAdapter;
...
public class PaymentService {
    ...
    private void initializePaymentAdapters() {
        ...
        // 添加银行卡支付
        paymentAdapters.put("bank", new BankCardAdapter());
        paymentAdapters.put("creditcard", new CreditCardAdapter("0000000000000000", "12/28", "000"));
    }
     ...
     * @return 支付适配器
     */
    public PaymentAdapter getPaymentAdapter(String type) {
