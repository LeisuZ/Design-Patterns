...
public class LogisticsService {
    ...
    public Logistics getLogisticsByOrderId(String orderId) {
        ...
        return logisticsList.stream()
                .filter(logistics -> orderId.equals(logistics.getOrderId()))
                .findFirst()
                .orElse(null);
    }
    ...
    public Logistics getLogisticsById(String id) {
        ...
        return logisticsList.stream()
                .filter(logistics -> id.equals(logistics.getId()))
                .findFirst()
                .orElse(null);
    }
     ...
     * @return 物流状态名称
     */
    public String getLogisticsStatus(String orderId) {
        Logistics logistics = getLogisticsByOrderId(orderId);
        if (logistics != null) {
            return logistics.getStatus().getName();
        }
        return "未发货";
    }
    ...
    public String getLogisticsInfo(String orderId) {
        ...
        if (logistics != null) {
            ...
            info.append("订单ID: " + logistics.getOrderId() + "\n");
            info.append("物流ID: " + logistics.getId() + "\n");
            info.append("配送方式: " + logistics.getDeliveryMethod().getName() + "\n");
            info.append("物流状态: " + logistics.getStatus().getName() + "\n");
            info.append("快递公司: " + (logistics.getCourierCompany() != null ? logistics.getCourierCompany() : "未分配") + "\n");
            info.append("物流单号: " + (logistics.getTrackingNumber() != null ? logistics.getTrackingNumber() : "未分配") + "\n");
            info.append("创建时间: " + logistics.getCreateTime() + "\n");
            if (logistics.getUpdateTime() != null) {
                info.append("更新时间: " + logistics.getUpdateTime() + "\n");
            }
